...
class PDF(FPDF):
    ...
    def footer(self):
        ...
        self.cell(95, 10, 'CONFIDENTIAL | K.N. Elettro Industries', 0, 0, 'L')
        self.cell(95, 10, f'Page {self.page_no()}/{{nb}} | ELETTRO Intelligence', 0, 0, 'R')
    ...
    def create_cover_page(self, customer_name, fy_list):
        ...
        self.set_text_color(218, 165, 32)
        self.multi_cell(120, 11, str(customer_name).upper(), 0, 'L')
        ...
        # Confidential notice (bottom of dark strip)
        self.set_xy(145, 255)
        self.set_font("Arial", '', 8)
        self.set_text_color(120, 120, 120)
